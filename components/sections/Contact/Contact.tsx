          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-green-900/30 rounded-lg p-6 mt-8">
                <h3 className="text-white font-semibold mb-4 flex items-center">
                  ...
                  {isCheckingAvailability && <RefreshCw className="w-4 h-4 ml-2 animate-spin" />}
                </h3>
                {isCheckingAvailability ? (
                  <p className="text-green-200 text-sm">Verificando disponibilidad...</p>
                  ...
                  <p className="text-red-300 text-sm">No hay horarios disponibles para esta fecha.</p>
                )}
              </div>
            )}
            ...
            <div className="bg-green-900/30 rounded-lg p-6 mt-8">
              ...
              <div className="space-y-3 text-green-200 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span>Se crea automáticamente la reunión de Google Meet</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                  <span>Se envían invitaciones por email a ambas partes</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
            ...
            {submitStatus.type && (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {submitStatus.alternativeSlots && submitStatus.alternativeSlots.length > 0 && (
                    <div className="mt-3">
                      <p className="text-yellow-200 text-sm mb-2">Horarios alternativos disponibles:</p>
                      <div className="grid grid-cols-3 gap-2">
              ...
              <div>
                ...
                <Select onValueChange={(value) => handleChange("duracion", value)} disabled={isSubmitting}>
                  ...
                  <SelectContent className="bg-gray-900 border-gray-700">
                    ...
                    <SelectItem value="45" className="text-white hover:bg-gray-800">
                      45 minutos
                    </SelectItem>
