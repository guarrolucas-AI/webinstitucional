...
export default function BusinessSimulator() {
  ...
  return (
    <section id='simulador' className="w-full mt-20 max-w-6xl mx-auto">
      <div className="relative">
        ...
        <h1 className="text-5xl font-normal text-white text-center mb-12">
  ...
  <TabsTrigger 
    value="chat" 
    className="flex-1 text-white mr-2 border-r border-orange-500/30 data-[state=active]:bg-white data-[state=active]:text-black"
  >
    Chat
  </TabsTrigger>
  <TabsTrigger 
    value="manual" 
    className="flex-1 text-white data-[state=active]:bg-white data-[state=active]:text-black rounded-md"
  >
    Entrada manual
  </TabsTrigger>
  <TabsTrigger 
    value="dashboard" 
    className="flex-1 text-white data-[state=active]:border-white data-[state=active]:text-black rounded-md"
  >
    Resultados
  </TabsTrigger>
</TabsList>
  ...
  <div className="relative border border-white/20 backdrop-blur-2xl rounded-lg p-6 text-white overflow-hidden">
    {/* Capa de desenfoque y mensaje superpuesto */}
    ...
    {/* Contenido original desenfocado visualmente */}
    <div className="pointer-events-none select-none opacity-50">
      <h3 className="text-xl mb-4">Simulación de Crecimiento y Consultoría Empresarial
  ...
  <h3 className="text-xl mb-3">Chat IA para Consultoría Empresarial
  ...
  {/* Capa bloqueadora por desarrollo */}
  <div className="absolute inset-0 z-10 bg-black/40 backdrop-blur-3xl flex items-center justify-center">
    <p className="text-white text-xl font-semibold text-center px-4">
