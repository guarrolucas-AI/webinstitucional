...
const cards = [
    {
      icon: <Instagram className="text-white text-lg" />,
      title: "Redes sociales",
      desc: "Captura atención visualmente.",
    },
    {
      icon: <Megaphone className="text-white text-lg" />,
      title: "Atracción",
      desc: "Genera tráfico cualificado.",
    },
    {
      icon: <BadgePercent className="text-white text-lg" />,
      title: "Conversión",
      desc: "Convierte tráfico en clientes.",
    },
  ];
